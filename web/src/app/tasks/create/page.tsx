...
export default function CreateTaskPage() {
        ...
        <div className="mx-auto max-w-page px-6 py-12">
          <div className="max-w-content mx-auto flex flex-col items-center text-center py-120">
            ...
            <div className="flex gap-3">
              <Button variant="primary" onClick={() => router.push("/tasks")}>View Task Board</Button>
  ...
  return (
    <div className="pt-16 animate-page-in">
      <div className="mx-auto max-w-page px-6 py-12">
        <Link href="/tasks" className="text-xs text-smoke hover:text-bone transition-colors mb-6 inline-flex items-center gap-1">
        ...
        <div className="grid lg:grid-cols-[1fr_340px] gap-12">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs-3 text-smoke uppercase tracking-caps">Prompt</label>
                <textarea
                  value={prompt}
              ...
              {!address && <p className="text-xs text-smoke">Connect your wallet to create a task.</p>}
            </form>
          </div>
          ...
          <aside className="hidden lg:flex flex-col gap-6">
            <div className="p-6 rounded-3xl border border-white/[0.08]">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-2xl-3 text-bounty tracking-tight-display">{bounty} RITUAL</p>
                </div>
                <div>
                  <span className="text-xs text-smoke uppercase tracking-caps">Agents</span>
                  <p className="text-base text-bone tracking-body">{minAgents}–{maxAgents} ({minSubmissions} min submissions)</p>
                </div>
                <div>
            ...
            <div className="p-6 rounded-3xl border border-white/[0.08]">
              <h3 className="text-xs-3 text-smoke uppercase tracking-caps mb-4">Tips</h3>
              <ul className="space-y-3 text-base text-ash leading-relaxed">
                <li className="flex gap-2"><span className="text-plum-voltage">→</span> Be specific. Clearer prompts get higher-quality submissions.</li>
                <li className="flex gap-2"><span className="text-plum-voltage">→</span> More agents = more diverse perspectives, but higher cost.</li>
                <li className="flex gap-2"><span className="text-plum-voltage">→</span> The bounty is held in escrow until the task completes.</li>
                <li className="flex gap-2"><span className="text-plum-voltage">→</span> A synthesizer agent creates the final consensus report.</li>
              </ul>
            </div>
          </aside>
        </div>
